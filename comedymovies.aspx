<%@ Page Title="" Language="C#" MasterPageFile="~/portal.master" AutoEventWireup="true" CodeFile="comedymovies.aspx.cs" Inherits="Default3" %>
...
<form id="form1" runat="server" method="post">
        ...
        <asp:listview runat="server" DataSourceID="SqlDataSource1" GroupItemCount="4">
            ...
            <LayoutTemplate>
                <table runat="server" style="width:100%;">
                    <tr runat="server">
                        <td runat="server">
                            <table id="groupPlaceholderContainer" runat="server" style="align-content:center; width:100%;background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;border-width:1px;font-family: Verdana, Arial, Helvetica, sans-serif;align-items:center;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:videoshopConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [name],[price],[imagepath] FROM [videoshop].[dbo].[movie] WHERE genre='Comedy' ORDER BY [year] DESC, [name]"></asp:SqlDataSource>
