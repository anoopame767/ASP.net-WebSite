<%@ Page Title="" Language="C#" MasterPageFile="~/portal.master" AutoEventWireup="true" CodeFile="actionmovies.aspx.cs" Inherits="Default2" %>
...
<form id="form1" runat="server" method="post">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:videoshopConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [name],[price], [imagepath] FROM [videoshop].[dbo].[movie] WHERE genre='Action' ORDER BY [year] DESC, [name]"></asp:SqlDataSource>
