<%@ Page Title="" Language="C#" MasterPageFile="~/portal.master" AutoEventWireup="true" CodeFile="dramamovies.aspx.cs" Inherits="Default4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <form id="form1" runat="server" method="post">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:videoshopConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [name],[price], [imagepath] FROM [videoshop].[dbo].[movie] WHERE genre='Drama' ORDER BY [year] DESC, [name]"></asp:SqlDataSource>
